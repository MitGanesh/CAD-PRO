...
const Projects = () => {
  return (
    <section className="text-white body-font relative w-full bg-fixed bg-center bg-cover custom-img1">
      <div className='absolute top-0 left-0 right-0 bottom-0 bg-black/50 z-[2]' />
      <div id='gallery' className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-10">
          <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-white z-[3]">Fetured Projects</h1>
          <h2 className="sm:text-2xl text-2xl font-medium title-font mb-4 text-white z-[3]">Our practice is built on an inclusive mode</h2>
